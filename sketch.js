...
player = createSprite(displayWidth-1150, displayHeight-300, 50, 50);
 player.addImage(hpImg)
   player.scale = 0.3
   player.debug = true
   player.setCollider("rectangle",0,0,500,900)
//setCollider.visible = false
   ...
   hallows1.visible = false
    ...
    hallows3 = createSprite(displayWidth-50,40,20,20)
...
//text("Press SPACE KEY to get Spells", + displayWidth-200,displayHeighjt/2-310 )
}
...
if(gameState == "lost"){
  ...
  textSize(50)
  fill("red")
  text("Oops!! YOU ARE KISSED BY THE DEMENTOR ",300,300)
...
function enemy(){
  if(frameCount%50===0){
    ...
    dementer = createSprite(random(500,1100),random(100,1000),100,40)

    dementer.addImage(dementerImg)
    dementer.scale = 0.15
    dementer.velocityX = -7
    dementer.debug= true
